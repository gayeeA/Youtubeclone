...
var previousCommentsContainer = document.querySelector(
  ".previoudCommentsContainer"
);
var commentCountElement = document.querySelector(".commentContainer h1");
var defaultChannelIconSrc = "./images/images/myImg.jpeg";

// Function to update the comment count
function updateCommentCount() {
  var comments = previousCommentsContainer.getElementsByClassName(
    "previousComments"
  );
